...
namespace MONOWar
{
    ...
    class Tile
    {
        ...
        public Rectangle unitRectangle
        {
            get
            {
                // Just gonna cheese it and put
                return new Rectangle(clickButton.xpos, clickButton.ypos, clickButton.width, clickButton.height);
            }
        }
        ...
        public void UpdateClickBox()
        {
            ...
            clickButton.xpos = Convert.ToInt32(tempboxx) + xpos + 14; // 14 is a tested number
